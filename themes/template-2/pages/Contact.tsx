      ...
      <section className="px-4 py-10 md:px-8 md:py-12 lg:px-10 lg:py-14">
        <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="relative mx-auto w-full max-w-sm lg:mx-0 lg:max-w-md">
            <div
              className="absolute -bottom-4 -left-4 z-0 h-28 w-28 border border-[#ff9a14] md:h-32 md:w-32"
              style={{
                backgroundImage:
                  "linear-gradient(45deg, #ff9a14 1px, transparent 1px), linear-gradient(-45deg, #ff9a14 1px, transparent 1px)",
            ...
            <div className="relative z-10 ml-5 mt-6 aspect-square overflow-hidden bg-[#eeeae4] md:ml-8 md:mt-8">
              <MediaImage
                src={mainImage}
                alt="Project detail"
                fill
            ...
            <div className="absolute left-0 top-0 z-20 h-24 w-24 overflow-hidden bg-[#ddd] shadow-md md:h-28 md:w-28">
              <MediaImage
                src={smallImage}
                alt="Workshop"
                fill
          ...
          <div className="lg:pl-4">
            ...
            <span className="mt-4 block h-[2px] w-12 bg-[#ff9a14]" />
            ...
            <div className="mt-6 flex items-center gap-5 text-xl text-[#ff9a14]">
